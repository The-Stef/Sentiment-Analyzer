...
Original file is located at
    https://colab.research.google.com/drive/1nYvi_8dz-DNp1snfYNLsZr9FAahJ6ybM
"""

!pip install nltk orjson ijson
...
validated_filee = data_validation("/content/chats.txt")

# CSV Way
# validated_csv_filee = convert_txt_to_csv(validated_filee)
# sentiment_dict = sentiment_analysis_csv(validated_csv_filee)

# JSON Way
validated_json_file = convert_txt_to_json(validated_filee)

# Use the result from above to generate a dictionary containing users and sentiment scores.
sentiment_dict = sentiment_analysis_json(validated_json_file)

# Use the dictionary to create sentiment charts for each group member.
get_charts(sentiment_dict)

!rm -rf sentiment_chart_images

convert_txt_to_csv(validated_filee)

# Commented out IPython magic to ensure Python compatibility.
def try_smth(no_times):
  for i in range(no_times):
    sentiment_analysis_csv(validated_csv_filee)
